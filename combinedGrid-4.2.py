#this file is a copy & paste of the file that Jayden edited and said it was not able to save on 11/12
#I (zaria) am doing this because I am not sure if its about to save after i run it on the computer better safe than sorry!

#changes
#the main changes jayden talked about were he commmented out all the image open lines because the computer was 
#confused on where to go to open the image and he just commented out all the exeception and error handling
...
def bound_trading_screen():
 ...
 # Display results in a table format
    for idx, (stock, current_price, low_bound, high_bound, action) in enumerate(results, start=2):
        label = tk.Label(bound_window, text=stock, font=('TkDefaultFont', 12))
