...
user_directory_path = r'C:\Users\zaria.ascue\Desktop\Profit Prophets.jpg'
flash_drive_path = r'E:\Profit Prophets - 4.1\Profit Prophets.jpg'
#handling the error image error
try:
    image = Image.open(flash_drive_path)
    #Profit Prophets - 4.1\Profit Prophets.jpg
