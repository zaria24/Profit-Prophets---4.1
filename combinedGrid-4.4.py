...
def range_trading_screen(): 
    ...
    for idx, (stock, current_price, low_range, high_range, action) in enumerate(results, start=2):
        ...
        low_range_label = tk.Label(range_trade_window, text=f"${low_range}", font=('TkDefaultFont', 12))
        low_range_label.grid(row=idx, column=2, padx=10, pady=5)

        high_range_label = tk.Label(range_trade_window, text=f"${high_range}", font=('TkDefaultFont', 12))
